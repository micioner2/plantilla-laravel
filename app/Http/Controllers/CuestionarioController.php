...
class CuestionarioController extends Controller
{
    ...
    public function listPreguntas(){
        $pregunta = DB::table("preguntas")->where('categoria',0)->get();
    ...
    public function regRespuesta(Request $request){
        ...
        $alumno = DB::table('alumnos')->where('id',$id_alumno)->update(['estadopregunta'=>$puntaje]);
